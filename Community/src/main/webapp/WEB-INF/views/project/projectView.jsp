                  ...
                  <ul class="avatars">
                    ...
                    <li>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Claire Connors">
                        <img alt="Claire Connors" class="avatar" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-1.jpg" />
                      </a>
                    </li>

                    <li>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Marcus Simmons">
                        <img alt="Marcus Simmons" class="avatar" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-1.jpg" />
                      </a>
                    </li>

                    <li>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Peggy Brown">
                        <img alt="Peggy Brown" class="avatar" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-2.jpg" />
                      </a>
                    </li>

                    <li>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Harry Xai">
                        <img alt="Harry Xai" class="avatar" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-2.jpg" />
                      </a>
                    </li>

                    <li>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Sally Harper">
                        <img alt="Sally Harper" class="avatar" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-3.jpg" />
                      </a>
                    </li>

                    <li>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Ravi Singh">
                        <img alt="Ravi Singh" class="avatar" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-3.jpg" />
                      </a>
                    </li>

                    <li>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="Kristina Van Der Stroem">
                        <img alt="Kristina Van Der Stroem" class="avatar" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-4.jpg" />
                      </a>
                    </li>

                    <li>
                      <a href="#" data-toggle="tooltip" data-placement="top" title="David Whittaker">
                        <img alt="David Whittaker" class="avatar" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-4.jpg" />
                      </a>
                    </li>
                              ...
                              <ul class="avatars">
                                ...
                                <li>
                                  <a href="#" data-toggle="tooltip" title="Kenny">
                                    <img alt="Kenny Tran" class="avatar" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-6.jpg" />
                                  </a>
                                </li>
                          ...
                          <li class="list-group-item dz-preview dz-file-preview">
                            <div class="media align-items-center dz-details">
                              <ul class="avatars">
                                ...
                                <li>
                                  <img alt="David Whittaker" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-4.jpg" class="avatar" data-title="David Whittaker" data-toggle="tooltip" />
                                </li>
                              </ul>
                              <div class="media-body d-flex justify-content-between align-items-center">
                                ...
                                <img alt="Loader" src="${pageContext.request.contextPath}/resources/assets/img/loader.svg" class="dz-loading" />
                                <div class="dropdown">
                          ...
                          <li class="list-group-item">
                            <div class="media align-items-center">
                              <ul class="avatars">
                                ...
                                <li>
                                  <img alt="Peggy Brown" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-2.jpg" class="avatar" data-title="Peggy Brown" data-toggle="tooltip" data-filter-by="data-title" />
                                </li>
                              </ul>
                              <div class="media-body d-flex justify-content-between align-items-center">
                                <div>
                          ...
                          <li class="list-group-item">
                            <div class="media align-items-center">
                              <ul class="avatars">
                                ...
                                <li>
                                  <img alt="Harry Xai" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-2.jpg" class="avatar" data-title="Harry Xai" data-toggle="tooltip" data-filter-by="data-title" />
                                </li>
                              </ul>
                              <div class="media-body d-flex justify-content-between align-items-center">
                                <div>
                          ...
                          <li class="list-group-item">
                            <div class="media align-items-center">
                              <ul class="avatars">
                                ...
                                <li>
                                  <img alt="Ravi Singh" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-3.jpg" class="avatar" data-title="Ravi Singh" data-toggle="tooltip" data-filter-by="data-title" />
                                </li>
                              </ul>
                              <div class="media-body d-flex justify-content-between align-items-center">
                                <div>
                          ...
                          <li class="list-group-item">
                            <div class="media align-items-center">
                              <ul class="avatars">
                                ...
                                <li>
                                  <img alt="Claire Connors" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-1.jpg" class="avatar" data-title="Claire Connors" data-toggle="tooltip" data-filter-by="data-title" />
                                </li>
                              </ul>
                              <div class="media-body d-flex justify-content-between align-items-center">
                                <div>
                          ...
                          <li class="list-group-item">
                            <div class="media align-items-center">
                              <ul class="avatars">
                                ...
                                <li>
                                  <img alt="David Whittaker" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-4.jpg" class="avatar" data-title="David Whittaker" data-toggle="tooltip" data-filter-by="data-title" />
                                </li>
                              </ul>
                              <div class="media-body d-flex justify-content-between align-items-center">
                                <div>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <ul class="avatars">
                              ...
                              <li>
                                <img alt="Claire" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-1.jpg" class="avatar" data-filter-by="alt" />
                              </li>
                            </ul>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <ul class="avatars">
                              ...
                              <li>
                                <img alt="Ravi" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-3.jpg" class="avatar" data-filter-by="alt" />
                              </li>
                            </ul>
                            <div class="media-body">
                              <div>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <ul class="avatars">
                              ...
                              <li>
                                <img alt="Kristina" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-4.jpg" class="avatar" data-filter-by="alt" />
                              </li>
                            </ul>
                            <div class="media-body">
                              <div>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <ul class="avatars">
                              ...
                              <li>
                                <img alt="Marcus" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-1.jpg" class="avatar" data-filter-by="alt" />
                              </li>
                            </ul>
                            <div class="media-body">
                              <div>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <ul class="avatars">
                              ...
                              <li>
                                <img alt="Sally" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-3.jpg" class="avatar" data-filter-by="alt" />
                              </li>
                            </ul>
                            <div class="media-body">
                              <div>
                        ...
                        <li class="list-group-item">
                          <div class="media align-items-center">
                            <ul class="avatars">
                              ...
                              <li>
                                <img alt="David" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-4.jpg" class="avatar" data-filter-by="alt" />
                              </li>
                            </ul>
                            <div class="media-body">
                              <div>
                      ...
                      <div class="users-manage" data-filter-list="form-group-users">
                        <div class="mb-3">
                          <ul class="avatars text-center">
                            ...
                            <li>
                              <img alt="Claire Connors" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-1.jpg" class="avatar" data-toggle="tooltip" data-title="Claire Connors" />
                            </li>

                            <li>
                              <img alt="Marcus Simmons" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-1.jpg" class="avatar" data-toggle="tooltip" data-title="Marcus Simmons" />
                            </li>

                            <li>
                              <img alt="Peggy Brown" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-2.jpg" class="avatar" data-toggle="tooltip" data-title="Peggy Brown" />
                            </li>

                            <li>
                              <img alt="Harry Xai" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-2.jpg" class="avatar" data-toggle="tooltip" data-title="Harry Xai" />
                            </li>
                        ...
                        <div class="form-group-users">
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-1">
                              <span class="d-flex align-items-center">
                                <img alt="Claire Connors" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-1.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-2">
                              <span class="d-flex align-items-center">
                                <img alt="Marcus Simmons" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-1.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-3">
                              <span class="d-flex align-items-center">
                                <img alt="Peggy Brown" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-2.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-4">
                              <span class="d-flex align-items-center">
                                <img alt="Harry Xai" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-2.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-5">
                              <span class="d-flex align-items-center">
                                <img alt="Sally Harper" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-3.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-6">
                              <span class="d-flex align-items-center">
                                <img alt="Ravi Singh" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-3.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-7">
                              <span class="d-flex align-items-center">
                                <img alt="Kristina Van Der Stroem" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-4.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-8">
                              <span class="d-flex align-items-center">
                                <img alt="David Whittaker" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-4.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-9">
                              <span class="d-flex align-items-center">
                                <img alt="Kerri-Anne Banks" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-5.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-10">
                              <span class="d-flex align-items-center">
                                <img alt="Masimba Sibanda" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-5.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-11">
                              <span class="d-flex align-items-center">
                                <img alt="Krishna Bajaj" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-6.jpg" class="avatar mr-2" />
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="user-manage-12">
                              <span class="d-flex align-items-center">
                                <img alt="Kenny Tran" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-6.jpg" class="avatar mr-2" />
            ...
            <div class="chat-module" data-filter-list="chat-module-body">
              <div class="chat-module-top">
                ...
                <div class="chat-module-body">
                  ...
                  <div class="media chat-item">
                    <img alt="Marcus" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-1.jpg" class="avatar" />
                    <div class="media-body">
                      <div class="chat-item-title">
                  ...
                  <div class="media chat-item">
                    <img alt="David" src="${pageContext.request.contextPath}/resources/assets/img/avatar-male-4.jpg" class="avatar" />
                    <div class="media-body">
                      <div class="chat-item-title">
                  ...
                  <div class="media chat-item">
                    <img alt="Sally" src="${pageContext.request.contextPath}/resources/assets/img/avatar-female-3.jpg" class="avatar" />
                    <div class="media-body">
                      <div class="chat-item-title">
